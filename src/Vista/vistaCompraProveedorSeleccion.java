 ...
 * @author John Castro
 */
public class vistaCompraProveedorSeleccion extends javax.swing.JFrame {
    ...
    public vistaCompraProveedorSeleccion(Conexion con1) {
        initComponents();
        setVisible(true);
    ...
    private void AgregarCompraButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarCompraButtonActionPerformed
        try{
        vistaCompra.cargarNit(String.valueOf(tablaProveedores.getValueAt(tablaProveedores.getSelectedRow(), 0)), String.valueOf(tablaProveedores.getValueAt(tablaProveedores.getSelectedRow(), 1)),String.valueOf(tablaProveedores.getValueAt(tablaProveedores.getSelectedRow(), 3)), String.valueOf(tablaProveedores.getValueAt(tablaProveedores.getSelectedRow(), 2)));
        dispose();
        }catch(Exception e){ JOptionPane.showMessageDialog(null,"Selecciona a un proveedor");}
